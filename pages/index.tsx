...
export default function Home() {
  return (
    <main className={`flex min-h-screen flex-col items-center bg-black text-white justify-center p-24 ${exo.className}`}>
      ...
      <button className="mt-6 p-2  bg-white text-black font-semibold rounded-lg hover:bg-red-500 hover:border-red-500 hover:text-white  hover:shadow-none transition duration-300">
        Show Me a Repo
      </button>
    </main>
  );
